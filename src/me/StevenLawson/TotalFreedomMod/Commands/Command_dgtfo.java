...
@CommandParameters(description = "Fun command.", usage = "/<command> <partialname>")
public class Command_dgtfo extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_Util.bcastMsg("Such " + player.getName() + ", very naughty, wow.", ChatColor.RED);
        ...
        // rollback
        server.dispatchCommand(sender, "co rb u:" + player.getName() + " t:100d r:global #silent");
