...
public class Command_sys extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole){
         ...
         if (!TFM_ConfigEntry.SERVER_EXECS.getList().contains(sender.getName()) || !TFM_ConfigEntry.SERVER_OWNERS.getList().contains(sender.getName()) || TFM_AdminList.isAdminImpostor((Player) sender))
        {
